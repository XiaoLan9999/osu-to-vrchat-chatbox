...
namespace OsuOscVRC.I18n
{
    public static class Translator
    {
        ...
        private static string ZH(string k) => k switch
        {
            ...
            "DispHiddenModsHint" => "用逗号或空格分隔，例如 RELAX, HD。RELAX 也会匹配 RX。",
        ...
        private static string EN(string k) => k switch
        {
            ...
            "DispHiddenModsHint" => "Separate names with commas or spaces, for example RELAX, HD. RELAX also matches RX.",
        ...
        private static string JP(string k) => k switch
        {
            ...
            "DispHiddenModsHint" => "カンマまたは空白で区切ります。例: RELAX, HD。RELAX は RX にも一致します。",
